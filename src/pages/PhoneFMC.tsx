    ...
    <div className="min-h-screen bg-background">
      ...
      <nav className="sticky top-0 z-50 flex items-center justify-between px-5 py-5 md:px-10 bg-background/95 backdrop-blur-md border-b border-vanta-border">
        ...
        <div className="flex items-center gap-3">
          <a href="/ontology?skip-auth=1" className="font-mono text-[10px] text-vanta-text-low uppercase tracking-wider hover:text-vanta-accent transition-colors">Ontology</a>
      ...
      <article className="max-w-[720px] mx-auto px-5 py-12 md:px-10 md:py-20">
        ...
        <section className="mb-12">
          ...
          <div className="space-y-3">
            {[
              ...
              <div
                key={item.approach}
                className={`p-4 border ${item.highlight ? "border-vanta-accent-phone-border bg-vanta-accent-phone-faint" : "border-vanta-border bg-card"}`}
              >
                <p className={`font-mono text-[11px] uppercase tracking-[0.12em] mb-1 ${item.highlight ? "text-vanta-accent-phone" : "text-vanta-text-mid"}`}>
                  {item.approach}
                </p>
        ...
        <section className="mb-12">
          <p className="font-mono text-[9px] uppercase tracking-[0.2em] text-vanta-text-low mb-4">
            Second-Order Effect: The Relationship Graph
          </p>
