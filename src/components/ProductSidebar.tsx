...
const productItems = [
  ...
  { title: "Zoom Meetings", url: "/product/meeting", icon: Video, color: "text-vanta-accent-zoom" },
  { title: "Native Phone", url: "/product/phone-call", icon: Phone, color: "text-vanta-accent-phone" },
  ...
  return (
    <Sidebar collapsible="icon" className="border-r border-vanta-border bg-vanta-bg">
      ...
      <SidebarContent>
        ...
        <SidebarGroup defaultOpen={productOpen}>
